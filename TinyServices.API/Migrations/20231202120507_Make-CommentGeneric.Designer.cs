...
namespace TinyServices.API.Migrations
{
    ...
    [Migration("20231202120507_Make-CommentGeneric")]
    partial class MakeCommentGeneric
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("NewsComment<NewsComment<News>>");
                });

            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsDisLike<TinyServices.API.NewsMagazine.Model.News>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("DisLikedEntityId")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsDisLike<TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsLike<TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>>", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>", b =>
                {
                    b.HasOne("TinyServices.API.NewsMagazine.Model.News", "CommentEntity")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>>", b =>
                {
                    b.HasOne("TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>", "CommentEntity")
                        .WithMany("Replies")
                        .HasForeignKey("CommentEntityId");

                    b.HasOne("TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>>", null)
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsDisLike<TinyServices.API.NewsMagazine.Model.News>", b =>
                {
                    b.HasOne("TinyServices.API.NewsMagazine.Model.News", "DisLikedEntity")
                        .WithMany("DisLikes")
                        .HasForeignKey("DisLikedEntityId");
            ...
            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsDisLike<TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>>", b =>
                {
                    b.HasOne("TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>", "DisLikedEntity")
                        .WithMany("DisLikes")
                        .HasForeignKey("DisLikedEntityId");
            ...
            modelBuilder.Entity("TinyServices.API.NewsMagazine.Model.NewsLike<TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>>", b =>
                {
                    b.HasOne("TinyServices.API.NewsMagazine.Model.NewsComment<TinyServices.API.NewsMagazine.Model.News>", "LikedEntity")
                        .WithMany("Likes")
                        .HasForeignKey("LikedEntityId");
