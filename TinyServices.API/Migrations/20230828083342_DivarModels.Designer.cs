...
namespace TinyServices.API.Migrations
{
    ...
    [Migration("20230828083342_DivarModels")]
    partial class DivarModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TinyServices.API.Divar.Model.Advertisement", b =>
                {
                    ...
                    b.HasOne("TinyServices.API.Divar.Model.User", null)
            ...
            modelBuilder.Entity("TinyServices.API.Divar.Model.CategoryProperty", b =>
                {
                    b.HasOne("TinyServices.API.Divar.Model.Category", null)
                        .WithMany("Properties")
                        .HasForeignKey("CategoryId");
                });
            ...
            modelBuilder.Entity("TinyServices.API.Divar.Model.PropertyValue", b =>
                {
                    b.HasOne("TinyServices.API.Divar.Model.Advertisement", null)
